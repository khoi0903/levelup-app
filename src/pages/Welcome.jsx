...
export default function Welcome({ onSignUpEmail, onNavigateToLogin }) {
  return (
    <div className="welcome-screen fade-in">
      {/* Decorative Top Gradient Background Mesh */}
      <div className="auth-bg-gradient"></div>

      {/* Logo & Brand Section */}
      <div className="auth-logo-section">
        <div className="auth-logo-circle">
          <Zap size={36} fill="#FFFFFF" color="#FFFFFF" />
        </div>
      ...
      <div className="auth-actions-group">
        ...
        {/* Social Authentication Round Buttons */}
        <div className="auth-social-row">
          <button className="social-circle-btn" onClick={onSignUpEmail} title="Đăng ký với Google">
            <GoogleIcon />
          </button>
          <button className="social-circle-btn" onClick={onSignUpEmail} title="Đăng ký với Facebook">
            <FacebookIcon />
          </button>
        </div>
      </div>

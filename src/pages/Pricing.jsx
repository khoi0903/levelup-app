...
import { Check, Star, Users, HelpCircle } from 'lucide-react';
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        'Lịch theo dõi Consistency Grid đầy đủ',
    ...
    <div className="pricing-screen fade-in">
      {!fromProfile ? (
        <div className="onboarding-progress">
          <div className="progress-step-text">STEP 2 OF 2</div>
          <div className="progress-track-full">
            <div className="progress-bar-fill" style={{ width: '100%' }}></div>
          </div>
        </div>
      ) : (
        <div className="pricing-back-header">
      ...
      <div className="pricing-actions">
        ...
        >
          {fromProfile ? 'Cập nhật gói đăng ký' : 'Bắt đầu hành trình'}
        </button>
      </div>
    </div>
  );
